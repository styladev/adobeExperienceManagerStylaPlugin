 ...
 ******************************************************************************/
package de.neofonie.styla.core.util;
...
public class StylaHelper {
    private static final Logger LOGGER = LoggerFactory.getLogger(StylaHelper.class);
    private static final String PROP_NAV_ROOT = "navRoot";

    /**
     * Returns the root page of the site
     * E.g.: /content/styla/us/en
